        ...
        <div class="table-items">
            <div class="bloc">
                <div class="bloc-item clearfix">
                    <div class="col-xs-12">
                        <a href="" class="link fright btn-delBloc"><i class="fa fa-trash"></i></a>
            ...
            <button type="button" class="btn btn-default btn-addBloc"><i class="far fa-plus-square"></i> Adicionar Bloco</button>
        </div>
        <hr>
    </div>
