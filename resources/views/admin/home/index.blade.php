            ...
            <div class="col-lg-10">
                ...
                <div class="row">
                    <div class="col-xs-12">
                        ...
                        <p>Sua lista de emails permite que você entre em contato com clientes ou visitantes interessados no
                            seu site. Chegar a eles com ofertas exclusivas ou atualizações sobre seus produtos.</p>
                        <br>
                        <div class="table-items">
                            <form method="post" action="" class="search search--users active">
                                <input type="text" name="search" placeholder="{{ __('Search') }}..." class="form-control search__input">
